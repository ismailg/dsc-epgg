...
Do not use this module for manuscript-facing results. Use the maintained
evaluation code in `src.analysis.evaluate_regime_conditional` instead.
"""
...
def _deprecated(*_args, **_kwargs):
    raise RuntimeError(
        "src.analysis.CIC is deprecated and intentionally disabled. "
