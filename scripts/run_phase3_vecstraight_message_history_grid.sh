...
OUT_ROOT="${REPO_ROOT}/outputs/eval/phase3_vecstraight_message_history_grid_${MILESTONE}_15seeds_${RUN_KIND}_${RUN_DATE}"
...
printf '%s\n' "milestone=${MILESTONE}" "interventions=${INTERVENTIONS[*]}" "histories=${HISTORYS[*]}" > "${REPORT_OUT}/message_history_grid_meta.txt"
